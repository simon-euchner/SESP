...
# ---------------------------------------------------------------------------- #
#                                                                              #
# Makefile for the *sesp* C-library by Simon Euchner.                          #
#                                                                              #
# ---------------------------------------------------------------------------- #
...
OBJ_FILENAMES = ${F01}.o ${F02}.o ${F03}.o ${F04}.o ${F05}.o ${F06}.o ${F07}.o \
				...
				${F36}.o ${F37}.o ${F38}.o ${F39}.o ${F40}.o ${F41}.o ${F42}.o \
				${F43}.o ${F44}.o ${F45}.o ${F46}.o ${F47}.o ${F48}.o ${F49}.o \
				${F50}.o ${F51}.o ${F52}.o ${F53}.o ${F54}.o ${F55}.o ${F56}.o \
				${F57}.o ${F58}.o ${F59}.o ${F60}.o ${F61}.o ${F62}.o ${F63}.o
...
${TARGET_DYN}: ${OBJ_FILES}
	${LD} ${OLVL} -o ${LIB}/libsesp.so ${OBJ}/${F01}.o ${OBJ}/${F02}.o \
		${OBJ}/${F03}.o ${OBJ}/${F04}.o ${OBJ}/${F05}.o ${OBJ}/${F06}.o \
		${OBJ}/${F07}.o ${OBJ}/${F08}.o ${OBJ}/${F09}.o ${OBJ}/${F10}.o \
		${OBJ}/${F11}.o ${OBJ}/${F12}.o ${OBJ}/${F13}.o ${OBJ}/${F14}.o \
		${OBJ}/${F15}.o ${OBJ}/${F16}.o ${OBJ}/${F17}.o ${OBJ}/${F18}.o \
		${OBJ}/${F19}.o ${OBJ}/${F20}.o ${OBJ}/${F21}.o ${OBJ}/${F22}.o \
		${OBJ}/${F23}.o ${OBJ}/${F24}.o ${OBJ}/${F25}.o ${OBJ}/${F26}.o \
		${OBJ}/${F27}.o ${OBJ}/${F28}.o ${OBJ}/${F29}.o ${OBJ}/${F30}.o \
		${OBJ}/${F31}.o ${OBJ}/${F32}.o ${OBJ}/${F33}.o ${OBJ}/${F34}.o \
		${OBJ}/${F35}.o ${OBJ}/${F36}.o ${OBJ}/${F37}.o ${OBJ}/${F38}.o \
		${OBJ}/${F39}.o ${OBJ}/${F40}.o ${OBJ}/${F41}.o ${OBJ}/${F42}.o \
		${OBJ}/${F43}.o ${OBJ}/${F44}.o ${OBJ}/${F45}.o ${OBJ}/${F46}.o \
		${OBJ}/${F47}.o ${OBJ}/${F48}.o ${OBJ}/${F49}.o ${OBJ}/${F50}.o \
		${OBJ}/${F51}.o ${OBJ}/${F52}.o ${OBJ}/${F53}.o ${OBJ}/${F54}.o \
		${OBJ}/${F55}.o ${OBJ}/${F56}.o ${OBJ}/${F57}.o ${OBJ}/${F58}.o \
		${OBJ}/${F59}.o ${OBJ}/${F60}.o ${OBJ}/${F61}.o ${OBJ}/${F62}.o \
		${OBJ}/${F63}.o -lm
${TARGET_STA}: ${OBJ_FILES}
	ar rcs ${LIB}/libsesp.a ${OBJ}/${F01}.o ${OBJ}/${F02}.o ${OBJ}/${F03}.o \
		${OBJ}/${F04}.o ${OBJ}/${F05}.o ${OBJ}/${F06}.o ${OBJ}/${F07}.o \
		${OBJ}/${F08}.o ${OBJ}/${F09}.o ${OBJ}/${F10}.o ${OBJ}/${F11}.o \
		${OBJ}/${F12}.o ${OBJ}/${F13}.o ${OBJ}/${F14}.o ${OBJ}/${F15}.o \
		${OBJ}/${F16}.o ${OBJ}/${F17}.o ${OBJ}/${F18}.o ${OBJ}/${F19}.o \
		${OBJ}/${F20}.o ${OBJ}/${F21}.o ${OBJ}/${F22}.o ${OBJ}/${F23}.o \
		${OBJ}/${F24}.o ${OBJ}/${F25}.o ${OBJ}/${F26}.o ${OBJ}/${F27}.o \
		${OBJ}/${F28}.o ${OBJ}/${F29}.o ${OBJ}/${F30}.o ${OBJ}/${F31}.o \
		${OBJ}/${F32}.o ${OBJ}/${F33}.o ${OBJ}/${F34}.o ${OBJ}/${F35}.o \
		${OBJ}/${F36}.o ${OBJ}/${F37}.o ${OBJ}/${F38}.o ${OBJ}/${F39}.o \
		${OBJ}/${F40}.o ${OBJ}/${F41}.o ${OBJ}/${F42}.o ${OBJ}/${F43}.o \
		${OBJ}/${F44}.o ${OBJ}/${F45}.o ${OBJ}/${F46}.o ${OBJ}/${F47}.o \
		${OBJ}/${F48}.o ${OBJ}/${F49}.o ${OBJ}/${F50}.o ${OBJ}/${F51}.o \
		${OBJ}/${F52}.o ${OBJ}/${F53}.o ${OBJ}/${F54}.o ${OBJ}/${F55}.o \
		${OBJ}/${F56}.o ${OBJ}/${F57}.o ${OBJ}/${F58}.o ${OBJ}/${F59}.o \
		${OBJ}/${F60}.o ${OBJ}/${F61}.o ${OBJ}/${F62}.o ${OBJ}/${F63}.o -lm
